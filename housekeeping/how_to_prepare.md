...
You should also download, print, and study the [Programmer's Pact](./ProgrammerPact_Python_2026.pdf). This is a single page document that specifies how your code has to be written.
